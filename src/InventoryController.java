    ...
    private void plant(ActionEvent event) {
        ...
        case "raspberryPlant" :
            if (game.getRaspberrySeedQuantity() > 0) {
                ...
                label.setText("You don't have any raspberry seeds to plant. Visit the market!");
            }
            break;
        case "strawberryPlant" :
            if (game.getStrawberrySeedQuantity() > 0) {
                ...
                label.setText("You don't have any strawberry seeds to plant. Visit the market!");
            }
            break;
        case "passionPlant" :
            if (game.getPassionFruitSeedQuantity() > 0) {
                ...
                label.setText("You don't have any passion fruit seeds to plant. Visit the market!");
            }
            break;
        case "grapePlant" :
            if (game.getGrapeSeedQuantity() > 0) {
                ...
                label.setText("You don't have any grape seeds to plant. Visit the market!");
            }
            break;
        case "watermelonPlant" :
            if (game.getWatSeedQ() > 0) {
                ...
                label.setText("You don't have any watermelon seeds to plant. Visit the market!");
            }
            break;
        case "pineapplePlant" :
            if (game.getPinSeedQ() > 0) {
                ...
                label.setText("You don't have any pineapple seeds to plant. Visit the market!");
            }
            break;
        case "dragonPlant" :
            if (game.getDragSeedQ() > 0) {
                ...
                label.setText("You don't have any dragon fruit seeds to plant. Visit the market!");
            }
            break;
        case "beanPlant" :
            if (game.getBeanSeedQ() > 0) {
                ...
                label.setText("You don't have any bean stalk seeds to plant. Visit the market!");
            }
            break;
        default :
            break;
        }
        inventoryCapacity.setText("Inventory Capacity: " + game.getTotalInventoryQuantity() + "/"
                + game.getInventoryCapacity());
        if (label.getText().equals("")) {
            label.setText("You don't have any empty plot spaces. Harvest some crops!");
        }
